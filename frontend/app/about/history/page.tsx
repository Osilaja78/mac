...
export const metadata: Metadata = {
  ...
  description: 'Learn about the rich history and evolution of Mother&apos;s Aid since our founding in 1995.',
}
      ...
      <div className="pt-24 pb-12 bg-[#f9f7f4]">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-gray-700 text-center max-w-2xl mx-auto">
            Since our founding in 1995, Mother&apos;s Aid has been committed to providing 
